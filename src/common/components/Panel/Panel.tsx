 ...
 * @param {Array<{columnIndex: number, widthPercent: number}>} headersWidth - Array of header widths in percentage
...
export const TableActionList = ({ style, options, onApply, defaultLabel = 'Bulk Action' }: TPanelListActionRowProps) => {
